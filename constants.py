...
ROOM_TABLE_HISTORY_COLUMNS_NAME = ["房源网站", "户型", "房价", ROOM_FETCH_DATE_COLUMN_NAME]
...
WEBSITE_ROOM_HISTORY_VIEW_COLUMNS = (
    ROOM_HISTORY_TABLE_COLUMNS + [ROOM_FETCH_DATE_COLUMN] + WEBSITE_ROOM_VIEW_ADDITIONAL_COLUMNS
)
